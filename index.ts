...
async function run() {
  try {
    ...
    app.get("/donation-requests", async (req: Request, res: Response) => {
    ...
    app.get("/donation-requests/:id", async (req: Request, res: Response) => {
  ...
  console.log(result);
    ...
    app.get("/districts/:id/upazilas", async (req: Request, res: Response) => {
    ...
    app.get("/fundings",  verifyToken, async (req: AuthRequest, res: Response) => {
      const result =
    ...
    app.get("/search-donors", async (req: Request, res: Response) => {
    ...
    app.post("/donation-requests", verifyToken, async (req: AuthRequest, res: Response) => {
    ...
    app.post("/fundings",verifyToken, async (req: AuthRequest, res: Response) => {
    ...
    app.delete("/donation-requests/:id",verifyToken, async (req: AuthRequest, res: Response) => {
      const id = req.params.id;
    ...
    app.patch("/donation-requests/:id",verifyToken, async (req: AuthRequest, res: Response) => {
      const id = req.params.id;
    ...
    app.patch("/users/:id",verifyToken, async (req: AuthRequest, res: Response) => {
      const id = req.params.id;
